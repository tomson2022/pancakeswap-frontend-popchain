...
export const SUBGRAPH_ENDPOINTS = {
  [ChainId.BSC]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/exchange-v2',
  [ChainId.ETHEREUM]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/exhange-eth',
  [ChainId.POPCHAIN]: GRAPH_API_POPCHAIN, // PopChain 主网使用相同的 subgraph
...
export const GRAPH_API_POTTERY = '' // 端点已被移除 - Endpoint has been removed
...
export const INFO_CLIENT_POPCHAIN_TESTNET = 'https://subgraph.popchain.ai/subgraphs/name/popchain-v2-swap'
...
export const INFO_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.POPCHAIN]: INFO_CLIENT_POPCHAIN, // PopChain 主网使用 PopChain Info Client
  [ChainId.POPCHAIN_TESTNET]: INFO_CLIENT_POPCHAIN, // PopChain 测试网使用 PopChain Info Client
}

export const BLOCKS_CLIENT_WITH_CHAIN = {
  [ChainId.BSC]: BLOCKS_CLIENT,
  [ChainId.ETHEREUM]: BLOCKS_CLIENT_ETH,
  [ChainId.POPCHAIN]: GRAPH_API_POPCHAIN, // PopChain 主网使用 PopChain subgraph
  [ChainId.POPCHAIN_TESTNET]: GRAPH_API_POPCHAIN, // PopChain 测试网使用 PopChain subgraph
}
