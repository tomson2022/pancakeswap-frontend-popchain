...
import UNSUPPORTED_TOKEN_LIST from '../../config/constants/tokenLists/popchain-unsupported.tokenlist.json'
import WARNING_TOKEN_LIST from '../../config/constants/tokenLists/popchain-warning.tokenlist.json'
...
function combineMaps(map1: TokenAddressMap, map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    [ChainId.POPCHAIN]: { ...map1[ChainId.POPCHAIN], ...map2[ChainId.POPCHAIN] },
    [ChainId.POPCHAIN_TESTNET]: { ...map1[ChainId.POPCHAIN_TESTNET], ...map2[ChainId.POPCHAIN_TESTNET] },
  }
}
