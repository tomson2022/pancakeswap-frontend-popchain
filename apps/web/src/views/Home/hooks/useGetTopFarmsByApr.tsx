...
const useGetTopFarmsByApr = (isIntersecting: boolean) => {
  ...
  }, [dispatch, fetchStatus, isIntersecting, chainId, farmFlag])
  ...
  useEffect(() => {
    ...
    if (fetchStatus === FetchStatus.Fetched && !fetched && farms?.length > 0) {
      getTopFarmsByApr(farms)
    }
  }, [farms, fetchStatus, cakePriceBusd, regularCakePerBlock, chainId, fetched])
