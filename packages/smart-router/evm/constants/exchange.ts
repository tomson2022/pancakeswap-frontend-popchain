import { ChainId, Token, WBNB, WNATIVE, WPOP } from '@pancakeswap/sdk'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.POPCHAIN_TESTNET]: '0xd793684055626bdfD1129BF781a2244Bb80956C2',
}
...
export const STABLE_SWAP_INFO_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.POPCHAIN]: '0x39b21a8B558f991295e3FF409DF9B68688fEF4DC',
  [ChainId.POPCHAIN_TESTNET]: '0xd793684055626bdfD1129BF781a2244Bb80956C2',
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.POPCHAIN]: [WPOP[ChainId.POPCHAIN], USDT[ChainId.POPCHAIN]],
  [ChainId.POPCHAIN_TESTNET]: [WPOP[ChainId.POPCHAIN_TESTNET], USDT[ChainId.POPCHAIN_TESTNET]],
}
