...
export const FACTORY_ADDRESS_MAP: Record<number, string> = {
  ...
  [ChainId.POPCHAIN]: '0x34d4d478a6e3c49B7427deCd4846AE532689183E', // PopChain 主网 Factory
  [ChainId.POPCHAIN_TESTNET]: '0x4377421f58B824C9D56CE773d8dde111590db87b',
}
...
export const WPOP = {
  [ChainId.POPCHAIN]: new ERC20Token(
    ChainId.POPCHAIN,
  ...
  [ChainId.POPCHAIN_TESTNET]: new ERC20Token(
...
export const WNATIVE: Record<number, ERC20Token> = {
  ...
  [ChainId.POPCHAIN]: WPOP[ChainId.POPCHAIN], // 主网使用新的 WPOP 配置
  [ChainId.POPCHAIN_TESTNET]: WPOP[ChainId.POPCHAIN_TESTNET],
}
