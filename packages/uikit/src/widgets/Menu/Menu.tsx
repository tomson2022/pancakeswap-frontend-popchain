...
const Wrapper = styled.div`
  ...
  min-height: 100vh; // 确保Wrapper也有最小高度
  background-color: ${({ theme }) => theme.colors.backgroundAlt}; // 设置背景色避免显示黑色
`;
...
const Menu: React.FC<React.PropsWithChildren<NavProps>> = ({
  ...
  return (
    <MenuContext.Provider value={{ linkComponent }}>
      <AtomBox
        asChild
        minHeight="100vh" // 统一设置最小高度为100vh，避免移动端出现黑色区域
      >
        <Wrapper>
          <FixedContainer showMenu={showMenu} height={totalTopMenuHeight}>
            ...
            <StyledNav>
              <Flex>
                <Logo href={homeLink?.href ?? "/"} useCustomLogo={useCustomLogo} isDark={isDark} />
